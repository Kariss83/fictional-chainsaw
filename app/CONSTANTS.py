STOPWORDS = ["a", "abord", "absolument", "afin", "ah", "ai", "aie", "ailleurs",
			 ...
			 "bonjour", "boum", "bravo", "brrr", "c", "car", "ce", "ceci",
			 ...
			 "moi-meme", "moi-même", "moindres", "moins", "mon", "monde",
			 "moyennant", "multiple", "multiples", "même", "mêmes", "n", "na",
			 "naturel", "naturelle", "naturelles", "ne", "neanmoins", "la"
			 ...
			 "tes", "tic", "tien", "tienne", "tiennes", "tiens", "toc",
			 "toi", "toi-même", "ton", "touchant", "toujours", "tous",
			 "tout", "toute", "toutefois", "toutes", "treize", "trente",
			 "tres", "trois", "troisième", "troisièmement", "trop", "très",
...
QUESTIONS = ["ou se trouve", "ou se situe", "la direction de",
			 "l'adresse de", "ou puis-je trouver", "ou puis je trouver",
			 "ou je peux trouver", "du cote de"]
